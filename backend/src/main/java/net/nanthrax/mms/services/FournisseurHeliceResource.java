...
import net.nanthrax.mms.persistence.FournisseurHeliceEntity;
import net.nanthrax.mms.persistence.HeliceCatalogueEntity;
...
public class FournisseurHeliceResource {
    ...
    public List<net.nanthrax.mms.persistence.FournisseurEntity> getFournisseursByHeliceId(@PathParam("heliceId") Long heliceId) {
