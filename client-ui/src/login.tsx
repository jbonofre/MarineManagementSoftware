...
export default function Login(props) {
    ...
    return(
        <Modal centered={true} mask={false} title={<Space>Espace client <Image width={50} src="./logo.png" preview={false}/></Space>} open={true} okText="Se connecter" cancelText="Effacer" closable={false} onOk={() => loginForm.submit()} onCancel={() => loginForm.resetFields()}>
