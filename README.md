...
Les frontends utilisent nginx pour servir le SPA et proxifier `/api/` ainsi que les endpoints d'authentification (`/users/`, `/portal/`, `/technicien-portal/`) vers le backend.
